...
import com.kube.noon.member.dto.member.UpdateMemberProfileIntroDto;
import org.mapstruct.Mapper;
import org.mapstruct.Mapping;

@Mapper(componentModel = "spring")
public interface UpdateMemberProfileIntroDtoBinder extends Binder<UpdateMemberProfileIntroDto, Member>{
    ...
    Member toEntity(UpdateMemberProfileIntroDto updateMemberProfileIntroDto);

    @Override
    UpdateMemberProfileIntroDto toDto(Member member);
}
